Rails.application.configure do
  ...
  # Mailer settings
  config.action_mailer.default_url_options = { host: 'https://stormy-sands-52277.herokuapp.com/' }
  Rails.application.routes.default_url_options[:host] = 'https://stormy-sands-52277.herokuapp.com/'
  ...
  # config.active_job.queue_name_prefix = "SongSpot_#{Rails.env}"
