...
Devise.setup do |config|
  ...
  # config.secret_key = '87a75a6a7f633fbaa1c74ce30a04f68a7fdb794de30c9380cf7e551c71a5769f4b4de9a895fcfbc985d3d090b50918461e4de3b3969d6eb2c42b40563a957b25'
  ...
  config.mailer_sender = 'cgreenwood1994@gmail.com'
  ...
  # modifying a user & used to authenticate or find a user.Default is:email.
  config.strip_whitespace_keys = [:email]

  # Tell if authentication through request.params is enabled. True by default.
  # It can be set to an array that wil enable params authentication only for the
  # given strategies, for example, `config.params_authenticatable = [:database]`
  #  wil enable it only for database (email + password) authentication.
  ...
  # config.pepper = 'bdb39a5a1ac48f068cac566f57bf15a529bc82be95a2d258b424691b77f26ddc491ed532b664bf87d4f0cbf5fe694804b6eee618c25065cb95170da1cf234ba0'
  ...
  # (then you should set stretches above to 20 for default behavior) and :restful_authentication_sha1 (then you should set
